            ...
            <div id="body" style="clear:left">
                <dl class="content">
					...
					<dd>
						...
						<input size="30" name="WIDout_trade_no" value="<%= request.getParameter("orderNumber") %>"/>
						<span>商户网站订单系统中唯一订单号，必填</span>
					</dd>
					<dt>订单名称：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDsubject" value="<%= request.getParameter("orderNumber") %>"/>
						<span>必填</span>
					</dd>
					<dt>付款金额：</dt>
					<dd>
						<span class="null-star">*</span>
						<input size="30" name="WIDtotal_fee" value="<%= request.getParameter("price") %>"/>
						<span>必填</span>
					</dd>
					<dt>订单描述：</dt>
					<dd>
