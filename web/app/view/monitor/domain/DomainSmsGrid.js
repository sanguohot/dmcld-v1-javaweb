...
var domainSmsStore=Ext.create('app.store.monitor.DomainSmsStore',{});
Ext.define('app.view.monitor.domain.DomainSmsGrid', {
		extend:'Ext.grid.Panel', 
		columnLines:true,
		id:'domainSmsGrid',
		store:domainSmsStore,
		title:tiSmsList,
		border:false,
		treeName:'',
		autoScroll:true,
...
//	       		 listeners:{
//	       		 	click:function(){
//					var domainUuid=Ext.getCmp('domainSmsGrid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'smsManager!exportDomainSms.action?domainUuid='+domainUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var domainUuid=Ext.getCmp('domainSmsGrid').treeName;	
//							Ext.getCmp('domainSmsGrid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
