...
Ext.define('app.view.monitor.domain.DomainCurGrid', {
...
//              ],
		columns: [
					...
					{header: 'domainName',dataIndex: 'domainName',width:120},
...
//	       		 listeners:{
//	       		 	click:function(){
//					var domainUuid=Ext.getCmp('domainCurGrid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdDomainCurManager!exportPmDomainCur.action?domainUuid='+domainUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var domainUuid=Ext.getCmp('domainCurGrid').treeName;	
//							Ext.getCmp('domainCurGrid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
...
//		     store: domainCurStore ,
		     ...
		     items:['-',{
	       		 ...
	       		 listeners:{
	       		 	click:function(){
					var domainUuids=this.up('panel').treeName;	
					
					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
   						if( e == 'yes' )
   						{
   							Ext.Ajax.request({
		                		url:'pmdDomainCurManager!exportPmDomainCur.action?domainUuids='+domainUuids,
		                		method:'POST',
		                		callback: function (options, success, response) {
   									var obj=Ext.JSON.decode(response.responseText);
			                    	if(obj["success"]){
