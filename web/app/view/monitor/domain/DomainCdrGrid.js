...
var domainCdrStore=Ext.create('app.store.monitor.DomainCdrStore',{});
Ext.define('app.view.monitor.domain.DomainCdrGrid', {
		extend:'Ext.grid.Panel', 
		columnLines:true,
		id:'domainCdrGrid',
		store:domainCdrStore,
		layout:'fit',
//		title:tiCdrList,
		border:false,
		treeName:'',
		...
		dockedItems : [{
		     ...
		     items:['-',{
	       		 ...
	       		 listeners:{
	       		 	click:function(){
					var domainUuid=Ext.getCmp('domainCdrGrid').treeName;	
					...
					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
   						...
   						{
   							Ext.Ajax.request({
		                		url:'cdrManager!exportDomainCdr.action?domainUuid='+domainUuid,
		                		method:'POST',
		                		timeout:10*60*1000,
		                		params:values,
