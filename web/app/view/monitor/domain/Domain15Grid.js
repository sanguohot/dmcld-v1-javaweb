var domain15Store=Ext.create('app.store.monitor.PmdDomain15Store',{})
Ext.define('app.view.monitor.domain.Domain15Grid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var domainUuid=Ext.getCmp('domain15Grid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdDomain15Manager!exportPmDomain15.action?domainUuid='+domainUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var domainUuid=Ext.getCmp('domain15Grid').treeName;	
//							Ext.getCmp('domain15Grid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
...
//				alert(tab.title + ' was activated.'+"tab.store="+tab.store+",tab.getStore()="+tab.getStore());
//				tab.getStore().load();
