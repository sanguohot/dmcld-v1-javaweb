...
Ext.define('app.view.monitor.domain.zone.GwCurGrid', {
...
//		store:gwCurStore,
		...
		columns: [
					...
					{header: 'neAlias',dataIndex: 'neAlias',width:120},
...
//	       		 listeners:{
//	       		 	click:function(){
//					var gwUuid=Ext.getCmp('gwCurGrid').treeName;	
//					var domainUuid=Ext.getCmp('gwCurGrid').domainUuid;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdGwCurManager!exportPmGwCur.action?gwUuid='+gwUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var gwUuid=Ext.getCmp('gwCurGrid').treeName;	
//							Ext.getCmp('gwCurGrid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
...
//		     store: gwCurStore ,
		     ...
		     items:[
	                '-', {
		       		 ...
		       		 listeners:{
		       		 	click:function(){
						var gwUuids=this.up('panel').treeName;	
						...
						Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
	   						...
	   						{
	   							Ext.Ajax.request({
			                		url:'pmdGwCurManager!exportPmGwCur.action?gwUuids='+gwUuids+"&domainUuid="+domainUuid,
			                		method:'POST',
			                		callback: function (options, success, response) {
	   									var obj=Ext.JSON.decode(response.responseText);
				                    	if(obj["success"]){
