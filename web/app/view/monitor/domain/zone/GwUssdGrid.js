...
var gwUssdStore=Ext.create('app.store.monitor.GwUssdStore',{});
Ext.define('app.view.monitor.domain.zone.GwUssdGrid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var gwUuid=Ext.getCmp('gwUssdGrid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'ussdManager!exportGwUssd.action?gwUuid='+gwUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var gwUuid=Ext.getCmp('gwUssdGrid').treeName;	
//							Ext.getCmp('gwUssdGrid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
