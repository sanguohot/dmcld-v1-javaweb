var gw24Store=Ext.create('app.store.monitor.PmdGw24Store',{});
Ext.define('app.view.monitor.domain.zone.Gw24Grid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var gwUuid=Ext.getCmp('gw24Grid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdGw24Manager!exportPmGw24.action?gwUuid='+gwUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var gwUuid=Ext.getCmp('gw24Grid').treeName;	
//							Ext.getCmp('gw24Grid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
