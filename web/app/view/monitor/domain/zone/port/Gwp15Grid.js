...
Ext.define('app.view.monitor.domain.zone.port.Gwp15Grid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var gwpUuid=Ext.getCmp('gwp15Grid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdGwp15Manager!exportPmGwp15.action?gwpUuid='+gwpUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var gwpUuid=Ext.getCmp('gwp15Grid').treeName;	
//							Ext.getCmp('gwp15Grid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
		{
		     ...
		     items:[
	                '-', {
						...
						Ext.MessageBox.confirm(boxWARNING,boxExport,function(e) { 																				
	   						if( e == 'yes' )
	   						{
	   							Ext.Ajax.request({
			                		url:'pmdGwp15Manager!exportPmGwp15.action?gwpUuid='+gwpUuid,
