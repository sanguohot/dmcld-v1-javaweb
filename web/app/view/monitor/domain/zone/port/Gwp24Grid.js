var gwp24Store=Ext.create('app.store.monitor.PmdGwp24Store',{});
Ext.define('app.view.monitor.domain.zone.port.Gwp24Grid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var gwpUuid=Ext.getCmp('gwp24Grid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdGwp24Manager!exportPmGwp24.action?gwpUuid='+gwpUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var gwpUuid=Ext.getCmp('gwp24Grid').treeName;	
//							Ext.getCmp('gwp24Grid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
