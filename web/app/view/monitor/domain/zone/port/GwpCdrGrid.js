...
var gwpCdrStore=Ext.create('app.store.monitor.GwpCdrStore',{});
Ext.define('app.view.monitor.domain.zone.port.GwpCdrGrid', {
		...
		dockedItems : [{
		     ...
		     items:[
	                '-', {
			       		 ...
			       		 listeners:{
			       		 	click:function(){
							var domainUuid=Ext.getCmp('gwpCdrGrid').treeName;	
							...
							Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
		   						...
		   						{
		   							Ext.Ajax.request({
				                		url:'cdrManager!exportGwpCdr.action?gwpUuid='+domainUuid,
				                		method:'POST',
				                		timeout:10*60*1000,
				                		params:values,
