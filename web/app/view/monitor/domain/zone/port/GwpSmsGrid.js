...
var gwpSmsStore=Ext.create('app.store.monitor.GwpSmsStore',{});
Ext.define('app.view.monitor.domain.zone.port.GwpSmsGrid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var gwpUuid=Ext.getCmp('gwpSmsGrid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'smsManager!exportGwpSms.action?gwpUuid='+gwpUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var gwpUuid=Ext.getCmp('gwpSmsGrid').treeName;	
//							Ext.getCmp('gwpSmsGrid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
