var domain24Store=Ext.create('app.store.monitor.PmdDomain24Store',{})
Ext.define('app.view.monitor.domain.Domain24Grid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var domainUuid=Ext.getCmp('domain24Grid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdDomain24Manager!exportPmDomain24.action?domainUuid='+domainUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var domainUuid=Ext.getCmp('domain24Grid').treeName;	
//							Ext.getCmp('domain24Grid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
