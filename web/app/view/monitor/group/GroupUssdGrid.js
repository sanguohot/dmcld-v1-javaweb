...
var groupUssdStore=Ext.create('app.store.monitor.GrpUssdStore',{});
Ext.define('app.view.monitor.group.GroupUssdGrid', {
		extend:'Ext.grid.Panel', 
		columnLines:true,
		id:'groupUssdGrid',
		store:groupUssdStore,
		title:tiUssdList,
		border:false,
		treeName:'',
		autoScroll:true,
...
//	       		 listeners:{
//	       		 	click:function(){
//					var groupUuid=Ext.getCmp('groupUssdGrid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'ussdManager!exportGroupUssd.action?grpUuid='+groupUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var groupUuid=Ext.getCmp('groupUssdGrid').treeName;	
//							Ext.getCmp('groupUssdGrid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
