var grp15Store=Ext.create('app.store.monitor.PmdGrp15Store',{});
Ext.define('app.view.monitor.group.Group15Grid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var groupUuid=Ext.getCmp('group15Grid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdGrp15Manager!exportPmGrp15.action?groupUuid='+groupUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var groupUuid=Ext.getCmp('group15Grid').treeName;	
//							Ext.getCmp('group15Grid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
