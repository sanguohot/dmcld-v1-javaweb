...
Ext.define('app.view.monitor.group.sim.Sim24Grid', {
...
//	       		 listeners:{
//	       		 	click:function(){
//					var simUuid=Ext.getCmp('sim24Grid').treeName;	
//					
//					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
//   						if( e == 'yes' )
//   						{
//   							Ext.Ajax.request({
//		                		url:'pmdSim24Manager!exportPmSim24.action?simUuid='+simUuid,
//		                		method:'POST',
...
//		       		 	click:function(){
//							var simUuid=Ext.getCmp('sim24Grid').treeName;	
//							Ext.getCmp('sim24Grid').getStore().load();
//		       	 		}
//		       	 	}
//	       	 }]
//		},
		     ...
		     items:['-',{
	       		...
	       		ulan:'btExport',
					...
					Ext.MessageBox.confirm(boxWarnning,boxExport,function(e) { 																				
   						...
   						{
   							Ext.Ajax.request({
		                		url:'pmdSim24Manager!exportPmSim24.action?',
		                		method:'POST',
		                		params:params,
		                		callback: function (options, success, response) {
   									var obj=Ext.JSON.decode(response.responseText);
