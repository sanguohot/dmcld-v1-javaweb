Ext.define("app.view.systemconfig.AddObjectType", {
	extend : 'Ext.window.Window',
	alias : 'widget.addObjectType',
	id:'addObjectType',
	title : lanControll.getLanValue('tiAddObjectType'),
	width : 500,
	closeAction: 'hide',
	closable:true,
	minWidth : 350,
    ...
    createForm:function(){
		return Ext.widget('form', {	
		    ...
		    items: [this.createObjectTypeId(),this.createName(),{
				xtype:'textareafield',
		        ...
		        handler: function() {
		            ...
		            if (this.up('form').getForm().isValid()) {
			                ...
			                var componentId=form.findField('componentId').getValue();
			                	Ext.Ajax.request({
			                		url:'objectTypeManager!addObjectType.action',
			                		method:'POST',
