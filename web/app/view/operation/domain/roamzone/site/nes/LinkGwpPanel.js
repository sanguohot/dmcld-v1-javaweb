Ext.define('app.view.operation.domain.roamzone.site.nes.LinkGwpPanel',{
		            ...
		            listeners:{
		                render : function(p) {
		                    p.getEl().on('mouseup', function(p){ 
		                    	var tip = Ext.getCmp('LinkGwpPanel_tip');
		                    	tip.show();
		                    });
	                	},
		        		focus:function(){
		        			...
		        			if(tip==undefined || tip==null){
		        				...
		        				tip = tipManage.createObjNameTipObj('LinkGwpPanel_tip',textobj.getEl().dom.id, gettip.getObjNameTip(textobj.fieldLabel));
		        			}
		        			tip.show();
		        			tip.clearListeners();
		        			//alert(tmp.html)
...
//						statusId : 3
			   ...
			   items: [
						...
						{xtype: 'button',ulan:'btToSimbankPort',text:' >> To SIMBANK Port',id:'linkBkpPort',
							listeners:{
							...
							var ss=Ext.create('app.util.SetBkpStore',{});
			     			...
			     			if(!isOpen){
			     				...
			     				var linkDwgPort=Ext.getCmp('linkDwgPort');
			     				var linkSimCard=Ext.getCmp('linkSimCard');
...
//			                    		Ext.getCmp('operationTree').store=s;
		       		...
		       		ulan:'btRefresh',
		       		 ...
		       		 listeners:{
		        			...
		        			var uuid=Ext.getCmp('linkGwpTab').getForm().findField('uuid').getValue();
		        			var linkGwpGwPanel=Ext.getCmp('linkGwpPanel');
