...
Ext.define("app.view.operation.domain.roamzone.site.UpgradeNeResult", {
	extend : 'Ext.window.Window',
	id:'maintenanceUpgradeNeResult',
    ...
    items: [{
        xtype: 'panel',
        itemId:'upgradeResultTip',
        html:'',
    },{
        xtype: 'gridpanel',
        itemId:'gridpanel',
        flex: 4,
        store:Ext.create("app.store.operation.domain.roamzone.site.nes.NeUpgradeResultStore",{}),
        columns: [
  				...
  				{header: 'Upgrade Result', dataIndex: 'result',flex:1,
