Ext.define('app.view.operation.domain.MiboxInDomainTab',{
...
//		autoScroll:true,
		...
		initComponent: function() {
			var nesInSiteStore= Ext.create('app.store.operation.domain.roamzone.site.NesAndLockSimStore', {}); 
//			nesInSiteStore.load();
...
//				plugins: [cellEditing],
				...
				columns: [
				         ...
				         {header: 'Device SN',  dataIndex: 'productSnStr',ulan:'productSn',  width:160},
						...
						{header: 'Opr Status',hidden:true, dataIndex: 'oprStatus',width:120,
							renderer:function(val){
						...
						{header: 'Device Model', dataIndex: 'productName', width:120},
				        {header: 'Version', dataIndex: 'packageVersion',ulan:'versionAbbr',width:120},
				        ...
				        {header: 'upgradeType', dataIndex: 'upgradeType',hidden:true},
						...
						{header: 'modStatus', dataIndex: 'modStatus', hidden:true,width:125,
							renderer:function(value,metaData,record,rowIndex,store,view){
								return rs.modStatus(value);
							}
						},
						{header: 'modSignalVal', dataIndex: 'modSignalVal'},
						{header: 'imsi', dataIndex: 'imsi'},
						{header: 'operator', dataIndex: 'operator'},
						{header: 'locMcc', dataIndex: 'locMcc'},
						{header: 'locMnc', dataIndex: 'locMnc'},
						{header: 'locLac', dataIndex: 'locLac'},
						{header: 'locCellId', dataIndex: 'locCellId'},
						{header: 'locStatus', dataIndex: 'locStatus'},
						{header: 'locLat', dataIndex: 'locLat'},
						{header: 'locLng', dataIndex: 'locLng'},
				],
				listeners:{
