Ext.define('app.view.log.LicSrvLogGrid',{
	...
	initComponent: function() {
		var gridStore= Ext.create("app.store.log.LicSrvLogStore");
		...
		var grid = Ext.create('Ext.grid.Panel', {
			...
			columns: [
					...
					{header: 'sysUuid',dataIndex: 'sysUuid',},
					...
					{header: 'srvMode', dataIndex: 'srvMode',hidden:true},
					{header: 'srvMagic', dataIndex: 'srvMagic',hidden:true},
