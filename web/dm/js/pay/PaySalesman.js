define(["pay-tree","pay-fun",'text!html/loading.html','text!html/pay/PayDetail.html']
    ...
    function createColEvents(pid,id){
	    ...
	    var del=function(e, value, row, index){
	    	...
	    	var cb=function(){
	    		fun.createDelAjax("salesManager!delSales.action",{name:row.name},id);
	    		fun.updateSalesVar();
	    	}
...
//	    	fun.toPayCar(pid,[row]);
	    	fun.updateSales(row,id);
	    	fun.updateSalesVar();
	    }
	    var salesDetail=function(e, value, row, index){
			require(["pay-sales-detail"], function(pay) {
	    ...
	    window.operateEvents = {
	        ...
	        'click a[action=salesDetail]':salesDetail
	    };
  }
...
//		        align: 'left',
		        ...
		        formatter:function(value,row,index){
		    	  var html='';
		    	  html+=''
		    		+'<a action="salesDetail"  class="blue" href="#" >'
					+value
					+'</a>'
					+'&nbsp;'
					return html;
				...
				field: 'mobile',
				title: window.lc.getValue("mobile"),
				align: 'center',
				valign: 'middle',
				sortable: true,
			},{
				...
				sortable: true,
		          ...
		          formatter:function(value,row,index){
			    	  var html='';
			    	  var modify='<a action="modify"  class="blue" href="#" >'
							+'修改'
							+'</a>';
			    	  var del='<a action="del"  class="blue Q-buy-btn" href="#" >'
							+'删除'
							+'</a>';
			    	  var salesDetail='<a action="salesDetail"  class="blue Q-buy-btn" href="#" >'
							+'查看'
							+'</a>';
