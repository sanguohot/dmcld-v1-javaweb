...
//			height: 500,
			...
			if(res && res.tblAlarmReportList){	
				
				
				obj["rows"]=res.tblAlarmReportList;
				obj.total=res["total"];
			}else{
				obj["rows"]=[];
				obj.total=0;
...
//			pageNumber:1,
			...
			columns: [
				...
				field: 'alarmNum',
				title: window.lc.getValue("alarmNum"),
				align: 'center',
				valign: 'middle',
				
			},{
				field: 'seriousAlarmNum',
				title: window.lc.getValue("seriousAlarmNum"),
				align: 'center',
				valign: 'middle',
				
				
			},{
				field: 'repairAlarmNum',
				title: window.lc.getValue("repairAlarmNum"),
				align: 'center',
				valign: 'middle',
				...
				field: 'pushAlarmNum',
				title: window.lc.getValue("pushAlarmNum"),
				align: 'center',
				valign: 'middle',
		...
		$("#alarm_report button[name=refresh]").addClass("btn-info btn-sm");
		 $("#alarm_report button[name=toggle]").addClass("btn-info btn-sm");
		 $("#alarm_report button[data-toggle=dropdown]").addClass("btn-info btn-sm");
		...
		$("#"+id+"-expt").click(function (){
			...
			$.ajax({
				url:'reportManager!expAlarmReport.action',
				type:'post',
				data:params,
