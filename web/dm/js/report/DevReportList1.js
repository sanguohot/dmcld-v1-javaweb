...
//			height: 500,
			...
			if(res && res.tblDevReportList){	
				
				
				obj["rows"]=res.tblDevReportList;
				obj.total=res["total"];
			}else{
				obj["rows"]=[];
				obj.total=0;
...
//			pageNumber:1,
			...
			columns: [
				...
				field: 'devNum',
				title: window.lc.getValue("devNum"),
				align: 'center',
				valign: 'middle',
				
			},{
				field: 'devRegisterNum',
				title: window.lc.getValue("devRegisterNum"),
				align: 'center',
				valign: 'middle',
				
				
			},{
				field: 'drpRegisterNum',
				title: window.lc.getValue("drpRegisterNum"),
				align: 'center',
				valign: 'middle',
				...
				field: 'devDeteleNum',
				title: window.lc.getValue("devDeteleNum"),
				align: 'center',
				valign: 'middle',
				...
				field: 'devRebootNum',
				title: window.lc.getValue("devRebootNum"),
				align: 'center',
				valign: 'middle',
		...
		$("#dev_report_list button[name=refresh]").addClass("btn-info btn-sm");
		 $("#dev_report_list button[name=toggle]").addClass("btn-info btn-sm");
		 $("#dev_report_list button[data-toggle=dropdown]").addClass("btn-info btn-sm");
		...
		$("#"+id+"-expt").click(function (){
			...
			$.ajax({
				url:'reportManager!expDevReport.action',
				type:'post',
				data:params,
